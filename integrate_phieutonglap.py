...
if 'import { PhieuTongLapTrangBiKyThuatForm }' not in content:
    content = 'import { PhieuTongLapTrangBiKyThuatForm } from "./PhieuTongLapTrangBiKyThuatForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "PHIEU_TONG_LAP" ? (
          <PhieuTongLapTrangBiKyThuatForm
...
if 'activeSubTabDef?.id === "PHIEU_TONG_LAP"' not in content:
