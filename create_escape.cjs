  ...
  sections: [
    {
      name: "I. ĐỘNG CƠ",
      items: [
        { tt: 1, name: "Cụm hút", quantity: "1b" },
        { tt: 2, name: "Ống thoát hơi máy", quantity: "1" },
        { tt: 3, name: "Cụm ống xả + tôn che ống xả", quantity: "1b" },
        { tt: 4, name: "Nắp đậy bánh răng cam cơ", quantity: "1b" },
        { tt: 5, name: "Nắp đậy dàn cò mổ", quantity: "1b" },
        ...
        { tt: 12, name: "Bát câu máy", quantity: "1b" },
        ...
        { tt: 21, name: "Ống chia nhiên liệu", quantity: "1b" },
        { tt: 22, name: "Mô bin đánh lửa", quantity: "4b" }
      ]
    },
    {
      name: "II. PHẦN XE",
    ...
    },
    {
      ...
      items: [
        ...
        { tt: 27, name: "Máy phát điện", quantity: "1b" },
        { tt: 28, name: "Rơle đề phụ", quantity: "1" },
        { tt: 29, name: "Bình điện", quantity: "1" },
        { tt: 30, name: "Tay gạt xi nhan", quantity: "1" },
        { tt: 31, name: "Công tắc điện", quantity: "1" },
        { tt: 32, name: "Buton nhấn còi", quantity: "1" },
        { tt: 33, name: "Còi điện", quantity: "2" },
        { tt: 34, name: "Máy gạt mưa T + S", quantity: "2b" },
        { tt: 35, name: "Cần gạt mưa", quantity: "3" },
        { tt: 36, name: "Bầu nước rửa kính trước sau", quantity: "2" },
        { tt: 37, name: "Béc phun + đường ống", quantity: "1b" },
        { tt: 38, name: "Đèn pha chính", quantity: "2b" },
        { tt: 39, name: "Đèn pha nhỏ", quantity: "2" },
        { tt: 40, name: "Đèn hiệu trước + sau", quantity: "2+2" },
        { tt: 41, name: "Đèn xinhan trước + sau", quantity: "2+2" },
        { tt: 42, name: "Đèn phanh sau", quantity: "2" },
    ...
    },
    {
      ...
      items: [
        ...
        { tt: 48, name: "Bost lái", quantity: "1b" },
        { tt: 49, name: "Rô tuyn CH ngang", quantity: "1+2" }
      ]
    },
    {
      ...
      items: [
        ...
        { tt: 52, name: "Bàn đạp", quantity: "1" },
        { tt: 53, name: "Bơm phanh cái", quantity: "1" },
        { tt: 54, name: "Bầu chứa dầu phanh", quantity: "1b" },
    ...
    },
    {
      ...
      items: [
        ...
        { tt: 94, name: "Cản trước + sau", quantity: "2" },
        { tt: 95, name: "Móc kéo trước + sau", quantity: "1b" }
      ]
    },
    {
      ...
      items: [
        ...
        { tt: 100, name: "Thùng nhiên liệu", quantity: "1b" },
        { tt: 101, name: "Bầu giảm thanh + Ống bô xả", quantity: "1b" },
        { tt: 102, name: "Giá + thùng bình điện", quantity: "1b" },
        { tt: 104, name: "Bảng đồng hồ", quantity: "1b" },
        { tt: 103, name: "Bộ radio catset", quantity: "1b" }
      ]
    },
    {
      name: "2.14 CÁC CẢM BIẾN HỘP ECU",
      items: [
        { tt: 105, name: "* Hộp ECU", quantity: "1b" },
        { tt: 106, name: "Cảm biến vị trí bướm ga", quantity: "1" },
        { tt: 107, name: "Cảm biến lưu lượng không khí", quantity: "1" }
      ]
    },
    {
      name: "2.15 Hệ thống điều hòa",
      items: [
        { tt: 108, name: "Máy nén", quantity: "1" },
        { tt: 109, name: "Két dàn nóng", quantity: "1" },
        { tt: 110, name: "-Khung bảovệ két DN", quantity: "1" },
        { tt: 111, name: "-Quạt dàn nóng", quantity: "1" },
        { tt: 112, name: "Phin + lọc ga", quantity: "1b" }
      ]
    }
  ]
};
...
fs.writeFileSync('src/templates/FordEscapeTemplate.json', JSON.stringify(data, null, 2), 'utf-8');
console.log('Ford Escape items:', data.sections.reduce((acc, sec) => acc + sec.items.length, 0));
