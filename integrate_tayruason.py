...
if 'import { TayRuaLamSachBeMatSonForm }' not in content:
    content = 'import { TayRuaLamSachBeMatSonForm } from "./TayRuaLamSachBeMatSonForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "TAY_RUA_SON" ? (
          <TayRuaLamSachBeMatSonForm
...
if 'activeSubTabDef?.id === "TAY_RUA_SON"' not in content:
