...
const data = {
  templateVersion: 1,
  vehicleCode: "MZ-SELECT",
  vehicleName: "Mitsubishi Zinger",
  ...
  sections: [
    {
      ...
      items: [
        ...
        { name: "-Đai kéo trục cam", quantity: "1" },
        { name: "-Bánh đai cam - cơ", quantity: "1b" },
        ...
        { name: "Bulon, Jujông, đai ốc, long đền, vòng kẹp, chi tiết khác (ghi tên, số lượng thiếu, số lượng hỏng thay)", quantity: "" }
      ]
    },
    {
      ...
      items: [
        ...
        { name: "Tay gạt xi nhan", quantity: "1" },
        ...
        { name: "Đèn quay trên nóc", quantity: "4b" },
        { name: "Còi hụ", quantity: "1" },
        { name: "BỘ ĐÀM", quantity: "1b" }
      ]
    },
    {
      name: "3- HỆ THỐNG LÁI",
      items: [
        ...
        { name: "Rô tuyn trụ trên", quantity: "2" },
        { name: "Thanh chuyển hướng", quantity: "2" },
        { name: "Cụm chữ A trên", quantity: "2b" },
        { name: "Thanh chữ I dưới", quantity: "2b" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Bộ đệm ghế", quantity: "07" },
        { name: "Khung ghế", quantity: "07" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Cửa gió dàn lạnh", quantity: "6" },
    ...
    },
    {
      ...
      items: [
        { name: "Ống cao su két nước", quantity: "2" },
        { name: "Cao su chân máy", quantity: "2" },
        { name: "Cao su hộp số", quantity: "1" },
        { name: "Joang kính cô định trước", quantity: "1" },
        { name: "Joang kính cố định sau", quantity: "1" },
        { name: "Joang cốp sau", quantity: "1" },
        { name: "Joang u quay kính", quantity: "4" },
        { name: "Joang cánh cửa", quantity: "4" },
        { name: "Joang nẹp kính", quantity: "4" },
        ...
        { name: "Tem xuất xuởng", quantity: "1b" }
      ]
    }
  ]
};
...
fs.writeFileSync(path.join(dir, 'MitsubishiZingerSelection.json'), JSON.stringify(data, null, 2), 'utf-8');
console.log('Mitsubishi Zinger Selection items:', data.sections.reduce((acc, sec) => acc + sec.items.length, 0));
