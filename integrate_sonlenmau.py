...
if 'import { SonLenMauForm }' not in content:
    content = 'import { SonLenMauForm } from "./SonLenMauForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "SON_LEN_MAU" ? (
          <SonLenMauForm
...
if 'activeSubTabDef?.id === "SON_LEN_MAU"' not in content:
