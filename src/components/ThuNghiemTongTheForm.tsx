...
export const ThuNghiemTongTheForm: React.FC<Props> = ({ vehicle, existingFormId, targetSessionId, templateName, stageName, templateType, initialData, onSaved, onClose }) => {
        ...
        >
          ...
          <div className="flex justify-between items-end mb-6 font-times text-[15px]">
            <div className="flex-1 flex mr-4">
              ...
              <input 
                type="text" 
                value={typeof (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Thử nghiệm tổng thể TBKT') === 'string' ? (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Thử nghiệm tổng thể TBKT').normalize('NFC') : (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Thử nghiệm tổng thể TBKT')}
            ...
            <div className="flex gap-4">
              ...
              <div className="flex">
                ...
                <input 
                  type="text" 
                  value={typeof (formData.soTo !== undefined ? formData.soTo : '3') === 'string' ? (formData.soTo !== undefined ? formData.soTo : '3').normalize('NFC') : (formData.soTo !== undefined ? formData.soTo : '3')}
            ...
            <table className="w-full border-collapse border-y border-x sm:border border-stone-300 sm:border-black text-[15px]">
              <thead className="hidden sm:table-header-group">
                <tr>
                  ...
                  <th className="border border-black px-2 py-2 text-center font-bold">Nội dung thử nghiệm</th>
          ...
          <div className="mb-4">
            ...
            <AutoResizeTextarea
              value={typeof (formData.ketLuan !== undefined ? formData.ketLuan : (formData.conclusion || 'Trang bị kỹ thuật đã được thử nghiệm các nội dung theo đúng Quy trình công nghệ.')) === 'string' ? (formData.ketLuan !== undefined ? formData.ketLuan : (formData.conclusion || 'Trang bị kỹ thuật đã được thử nghiệm các nội dung theo đúng Quy trình công nghệ.')).normalize('NFC') : (formData.ketLuan !== undefined ? formData.ketLuan : (formData.conclusion || 'Trang bị kỹ thuật đã được thử nghiệm các nội dung theo đúng Quy trình công nghệ.'))}
