...
export const SuaChuaChiTietCumGamForm: React.FC<Props> = ({ vehicle, existingFormId, targetSessionId, templateName, stageName, templateType, initialData, onSaved, onClose }) => {
        ...
        >
          ...
          <div className="flex justify-between items-end mb-6 font-times text-[15px]">
            <div className="flex-1 flex mr-4">
              ...
              <input 
                type="text" 
                value={typeof (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Sửa chữa chi tiết, linh kiện của cụm gầm') === 'string' ? (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Sửa chữa chi tiết, linh kiện của cụm gầm').normalize('NFC') : (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Sửa chữa chi tiết, linh kiện của cụm gầm')}
            ...
            <div className="flex gap-4">
              ...
              <div className="flex">
                ...
                <input 
                  type="text" 
                  value={typeof (formData.soTo !== undefined ? formData.soTo : '8') === 'string' ? (formData.soTo !== undefined ? formData.soTo : '8').normalize('NFC') : (formData.soTo !== undefined ? formData.soTo : '8')}
