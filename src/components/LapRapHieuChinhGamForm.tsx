...
const ITEMS: any[] = [
  ...
  { category: 'II. HỆ THỐNG PHANH:', stt: '-', noiDung: 'Xe phải dừng lại hẳn trong vòng :', yeuCau: '6m. Không lệch quá 8°' },
...
export const LapRapHieuChinhGamForm: React.FC<Props> = ({ vehicle, existingFormId, targetSessionId, templateName, stageName, templateType, initialData, onSaved, onClose }) => {
        ...
        >
          ...
          <div className="flex justify-between items-end mb-6 font-times text-[15px]">
            <div className="flex-1 flex mr-4">
              ...
              <input 
                type="text" 
                value={typeof (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Lắp ráp, hiệu chỉnh, chạy rà cụm gầm') === 'string' ? (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Lắp ráp, hiệu chỉnh, chạy rà cụm gầm').normalize('NFC') : (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Lắp ráp, hiệu chỉnh, chạy rà cụm gầm')}
