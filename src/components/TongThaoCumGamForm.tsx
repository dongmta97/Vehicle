...
export const TongThaoCumGamForm: React.FC<Props> = ({ vehicle, existingFormId, targetSessionId, templateName, stageName, templateType, initialData, onSaved, onClose }) => {
        ...
        >
          ...
          <div className="flex justify-between items-end mb-6 font-times text-[15px]">
            <div className="flex-1 flex mr-4">
              ...
              <input 
                type="text" 
                value={typeof (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Tổng tháo cụm gầm') === 'string' ? (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Tổng tháo cụm gầm').normalize('NFC') : (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Tổng tháo cụm gầm')}
