...
export const SonLenMauForm: React.FC<Props> = ({ vehicle, existingFormId, targetSessionId, templateName, stageName, templateType, initialData, onSaved, onClose }) => {
  ...
  const [formData, setFormData] = useState<any>(() => {
    ...
    return {
      ...
      conclusion: '',
      ketLuan: 'Thân, vỏ xe được sơn lên màu đúng Quy trình công nghệ.',
        ...
        >
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="text-center flex-1">
              ...
              <div className="italic text-lg mt-1 font-times">
                ...
                <input 
                  type="text" 
                  value={typeof (formData.soPhieu !== undefined ? formData.soPhieu : '4') === 'string' ? (formData.soPhieu !== undefined ? formData.soPhieu : '4').normalize('NFC') : (formData.soPhieu !== undefined ? formData.soPhieu : '4')}
          ...
          <div className="flex justify-between items-end mb-6 font-times text-[15px]">
            <div className="flex-1 flex mr-4">
              ...
              <input 
                type="text" 
                value={typeof (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Sơn lên màu') === 'string' ? (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Sơn lên màu').normalize('NFC') : (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Sơn lên màu')}
          ...
          <div className="mb-4">
            ...
            <AutoResizeTextarea
              value={typeof (formData.ketLuan !== undefined ? formData.ketLuan : (formData.conclusion || 'Thân, vỏ xe được sơn lên màu đúng Quy trình công nghệ.')) === 'string' ? (formData.ketLuan !== undefined ? formData.ketLuan : (formData.conclusion || 'Thân, vỏ xe được sơn lên màu đúng Quy trình công nghệ.')).normalize('NFC') : (formData.ketLuan !== undefined ? formData.ketLuan : (formData.conclusion || 'Thân, vỏ xe được sơn lên màu đúng Quy trình công nghệ.'))}
