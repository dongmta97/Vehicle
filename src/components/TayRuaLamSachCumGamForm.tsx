...
const ITEMS: any[] = [
  ...
  { category: 'I. TẨY RỬA LÀM SẠCH CHI TIẾT', stt: '-', noiDung: 'Các bó nhíp', yeuCau: 'Sạch sẽ, không han rỉ. Thoa lớp mỡ chì mỏng sau khi vệ sinh, làm sạch' },
...
export const TayRuaLamSachCumGamForm: React.FC<Props> = ({ vehicle, existingFormId, targetSessionId, templateName, stageName, templateType, initialData, onSaved, onClose }) => {
