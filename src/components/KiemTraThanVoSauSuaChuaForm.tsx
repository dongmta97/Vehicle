...
const ITEMS: any[] = [
  ...
  { category: 'I. KHUNG XE', stt: '-', noiDung: 'Sai lệch khoảng cách A và B (A = khoảng cách từ trục nhíp trước bên trái đến trục nhíp sau bên phải.) (B = khoảng cách từ trục nhíp trước bên phải đến trục nhíp sau bên trái.)', yeuCau: '< 7mm' },
  ...
  { category: 'II. Thân xe', stt: '-', noiDung: 'Khe hở mép cửa hậu', yeuCau: '+ Theo viền bên: 2 ÷ 6 mm | + Theo viền đáy: 5 ÷ 9 mm' },
...
export const KiemTraThanVoSauSuaChuaForm: React.FC<Props> = ({ vehicle, existingFormId, targetSessionId, templateName, stageName, templateType, initialData, onSaved, onClose }) => {
        ...
        >
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="text-center flex-1">
              ...
              <div className="italic text-lg mt-1 font-times">
                ...
                <input 
                  type="text" 
                  value={typeof (formData.soPhieu !== undefined ? formData.soPhieu : '1') === 'string' ? (formData.soPhieu !== undefined ? formData.soPhieu : '1').normalize('NFC') : (formData.soPhieu !== undefined ? formData.soPhieu : '1')}
          ...
          <div className="flex justify-between items-end mb-6 font-times text-[15px]">
            <div className="flex-1 flex mr-4">
              ...
              <input 
                type="text" 
                value={typeof (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Kiểm tra sau sửa chữa thân, vỏ xe') === 'string' ? (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Kiểm tra sau sửa chữa thân, vỏ xe').normalize('NFC') : (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Kiểm tra sau sửa chữa thân, vỏ xe')}
            ...
            <div className="flex gap-4">
              ...
              <div className="flex">
                ...
                <input 
                  type="text" 
                  value={typeof (formData.soTo !== undefined ? formData.soTo : '2') === 'string' ? (formData.soTo !== undefined ? formData.soTo : '2').normalize('NFC') : (formData.soTo !== undefined ? formData.soTo : '2')}
          ...
          <div className="mb-4">
            ...
            <AutoResizeTextarea
              value={typeof (formData.ketLuan !== undefined ? formData.ketLuan : (formData.conclusion || 'Thân, vỏ đã được kiểm tra đúng Quy trình công nghệ.')) === 'string' ? (formData.ketLuan !== undefined ? formData.ketLuan : (formData.conclusion || 'Thân, vỏ đã được kiểm tra đúng Quy trình công nghệ.')).normalize('NFC') : (formData.ketLuan !== undefined ? formData.ketLuan : (formData.conclusion || 'Thân, vỏ đã được kiểm tra đúng Quy trình công nghệ.'))}
