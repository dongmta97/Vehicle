...
const DEFAULT_TASKS: TaskPlanItem[] = [
        ...
        >
          ...
          <div className="mb-6 relative">
            <table className="w-full border-collapse border border-black text-[15px]">
              <thead>
                <tr>
                  <th className="border border-black px-2 py-2 text-center w-28 font-bold">Thứ ngày</th>
                  <th className="border border-black px-2 py-2 text-center font-bold">Nội dung công việc</th>
                  <th className="border border-black px-2 py-2 text-center w-40 font-bold">Cán bộ phụ trách</th>
                  <th className="border border-black px-2 py-2 text-center w-40 font-bold">Nhân viên thực hiện</th>
                        ...
                        >
                          <span className="flex-1 whitespace-pre-wrap">
                            {item.assignedTo ? (
                              ...
                              <span className="print:hidden text-stone-400 font-normal text-xs">Chọn cán bộ...</span>
                            )}
                          </span>
                        </div>
