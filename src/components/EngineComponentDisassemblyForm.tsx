...
export const EngineComponentDisassemblyForm: React.FC<Props> = ({ vehicle, existingFormId, targetSessionId, templateName, stageName, templateType, initialData, onSaved, onClose }) => {
          ...
          <div className="mb-6 grid grid-cols-2 gap-8 text-[15px] leading-relaxed">
            ...
            <div className="space-y-2">
              <div className="flex gap-2">
                ...
                <input 
                  type="text" 
                  value={typeof (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Tổng tháo cụm động cơ') === 'string' ? (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Tổng tháo cụm động cơ').normalize('NFC') : (formData.cumCongDoan !== undefined ? formData.cumCongDoan : 'Tổng tháo cụm động cơ')}
