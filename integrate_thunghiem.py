...
if 'import { ThuNghiemTongTheForm }' not in content:
    content = 'import { ThuNghiemTongTheForm } from "./ThuNghiemTongTheForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "THU_NGHIEM_TONG_THE" ? (
          <ThuNghiemTongTheForm
...
if 'activeSubTabDef?.id === "THU_NGHIEM_TONG_THE"' not in content:
