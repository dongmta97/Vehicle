...
if 'import { KiemTraSauTongLapGamForm }' not in content:
    content = 'import { KiemTraSauTongLapGamForm } from "./KiemTraSauTongLapGamForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "KIEM_TRA_GAM" ? (
          <KiemTraSauTongLapGamForm
...
if 'activeSubTabDef?.id === "KIEM_TRA_GAM"' not in content:
