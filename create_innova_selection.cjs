...
fs.writeFileSync(path.join(dir, 'ToyotaInnovaSelection.json'), JSON.stringify(data, null, 2), 'utf-8');
console.log('Toyota Innova Selection items:', data.sections.reduce((acc, sec) => acc + sec.items.length, 0));
