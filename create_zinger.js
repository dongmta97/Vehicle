  ...
  sections: [
    {
      ...
      items: [
        ...
        { tt: 19, name: "Kim phun", quantity: "4b" },
    ...
    },
    {
      ...
      items: [
        ...
        { tt: 32, name: "Cụm tay gạt xi nhan tổng hợp", quantity: "1b" },
    ...
    },
    {
      ...
      items: [
        ...
        { tt: 56, name: "Bót lái", quantity: "1b" },
    ...
    },
    {
      ...
      items: [
        ...
        { tt: 71, name: "Bơm ly hợp chính", quantity: "1" },
    ...
    },
    {
      name: "2.6. CARDAN",
      items: [
        { tt: 0, name: "2.6. CARDAN", quantity: "1b" }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        { tt: 106, name: "Lốp xe", quantity: "5" },
        { tt: 80, name: "Ống giảm xóc T+S", quantity: "4" },
        { tt: 81, name: "Lò xo giảm chấn trước sau", quantity: "2b" },
        { tt: 82, name: "Nhíp sau", quantity: "2b" }
      ]
    },
    {
      name: "2.10. CABIN THÂN XE",
      items: [
        { tt: 83, name: "Kính chắn gió", quantity: "1" },
        { tt: 84, name: "Kính chiếu hậu ngoài", quantity: "2" },
        { tt: 85, name: "Kính chiếu hậu trong", quantity: "1" },
        { tt: 86, name: "Cánh cửa", quantity: "5" },
        { tt: 87, name: "Kính cửa hông", quantity: "4" },
        { tt: 88, name: "Mô tơ nâng hạ kính", quantity: "4" },
        { tt: 89, name: "Compa nâng hạ kính", quantity: "4" },
        { tt: 90, name: "Tay mở của ngoài", quantity: "5" },
        { tt: 91, name: "Tay mở cửa trong", quantity: "5" },
        { tt: 92, name: "Nút nâng hạ kính", quantity: "4" },
        { tt: 93, name: "Ổ khóa cửa", quantity: "5" },
        { tt: 94, name: "Xylanh nâng cửa sau", quantity: "2" }
      ]
    },
    {
      name: "2.11. NỘI THẤT",
      items: [
        { tt: 95, name: "Tấm che nắng tài xế", quantity: "2" },
        { tt: 96, name: "Ghế tài xế", quantity: "1" },
        { tt: 97, name: "Ghế phụ cửa hông", quantity: "7" },
        { tt: 98, name: "Tay nắm trần", quantity: "5" },
        { tt: 99, name: "La phông trần", quantity: "1b" }
      ]
    },
    {
      name: "2.12. KHUNG XE",
      items: [
        { tt: 100, name: "Biển số", quantity: "2" },
        { tt: 101, name: "Cản trước + sau", quantity: "1" },
        { tt: 102, name: "Móc kéo trước + sau", quantity: "2+2" }
      ]
    },
    {
      name: "2.13. TRANG BỊ KHÁC",
      items: [
        { tt: 103, name: "Két nước + bọc gió", quantity: "1b" },
        { tt: 104, name: "Bầu lọc gió", quantity: "1b" },
        { tt: 105, name: "Giá bắt lốp dự phòng", quantity: "1b" },
        { tt: 107, name: "Thùng nhiên liệu", quantity: "2b" },
        { tt: 108, name: "Bầu giảm thanh + Ống bô xả", quantity: "1b" },
        { tt: 109, name: "Giá + thùng bình điện", quantity: "1b" },
        { tt: 110, name: "Bộ radio catset", quantity: "1b" },
        { tt: 111, name: "Bảng đồng hồ", quantity: "1b" }
      ]
    },
    {
      name: "2.14 CÁC CẢM BIẾN , RỜ LE , CẦU CHÌ , HỘP ECU",
      items: [
        { tt: 112, name: "* Hộp ECU", quantity: "1b" },
        { tt: 113, name: "Cảm biến vị trí Tr/ cơ", quantity: "1" },
        { tt: 114, name: "----------- vị trí Tr/cam", quantity: "1" },
        { tt: 115, name: "----------vị trí bướm ga", quantity: "1" },
        { tt: 116, name: "--lưu lượng không khí", quantity: "1" }
      ]
    },
    {
      name: "2.15 Hệ thống điều hòa",
      items: [
        { tt: 117, name: "Máy nén", quantity: "1" },
        { tt: 118, name: "Két dàn nóng", quantity: "1" },
        { tt: 119, name: "-Khung bảo vệ két DN", quantity: "" },
        { tt: 120, name: "-Quạt dàn nóng", quantity: "1" },
        { tt: 121, name: "Phin + lọc ga", quantity: "1b" }
      ]
    }
  ]
};

fs.writeFileSync('src/templates/MitsubishiZingerTemplate.json', JSON.stringify(data, null, 2), 'utf-8');
console.log('Total sections:', data.sections.length);
console.log('Total items:', data.sections.reduce((acc, sec) => acc + sec.items.length, 0));
