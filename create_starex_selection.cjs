  ...
  sections: [
    {
      ...
      items: [
        ...
        { name: "Cao su chân máy", quantity: "3" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Đĩa phanh trước + sau", quantity: "2+2" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Bộ đệm ghế", quantity: "08" },
        { name: "Khung ghế", quantity: "08" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Kính hông xe", quantity: "8" },
        { name: "-Khóa hãm ngoài", quantity: "8" },
        ...
        { name: "-Tay mở ngoài cửa", quantity: "2" },
        { name: "-Tay mỡ trong cửa hông", quantity: "2" },
        { name: "-Tay mở ngoài cửa hông", quantity: "2" },
        { name: "Cửa sau xe (1cánh lớn", quantity: "1b" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Joang ống cưả hông", quantity: "1" },
        { name: "Joang ống cửa sau", quantity: "1" },
        { name: "Joang U quay kính", quantity: "2" },
        { name: "Joang ống viền cánh cửa", quantity: "2" },
        { name: "Joang kính cố định", quantity: "5" },
        ...
        { name: "Chữ thập hông xe", quantity: "3" }
      ]
    }
  ]
};
...
fs.writeFileSync(path.join(dir, 'HyundaiStarexSelection.json'), JSON.stringify(data, null, 2), 'utf-8');
console.log('Hyundai Starex Selection items:', data.sections.reduce((acc, sec) => acc + sec.items.length, 0));
