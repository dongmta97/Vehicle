...
if 'import { TongThaoCumGamForm }' not in content:
    content = 'import { TongThaoCumGamForm } from "./TongThaoCumGamForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "TONG_THAO_CUM_GAM" ? (
          <TongThaoCumGamForm
...
if 'activeSubTabDef?.id === "TONG_THAO_CUM_GAM"' not in content:
