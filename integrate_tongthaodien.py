...
if 'import { TongThaoCumDienForm }' not in content:
    content = 'import { TongThaoCumDienForm } from "./TongThaoCumDienForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "TONG_THAO_CUM_DIEN" ? (
          <TongThaoCumDienForm
...
if 'activeSubTabDef?.id === "TONG_THAO_CUM_DIEN"' not in content:
