...
if 'import { XuLyBeMatThanVoForm }' not in content:
    content = 'import { XuLyBeMatThanVoForm } from "./XuLyBeMatThanVoForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "XU_LY_BE_MAT" ? (
          <XuLyBeMatThanVoForm
...
if 'activeSubTabDef?.id === "XU_LY_BE_MAT"' not in content:
