...
if 'import { KiemTraSauTongLapDienForm }' not in content:
    content = 'import { KiemTraSauTongLapDienForm } from "./KiemTraSauTongLapDienForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "KIEM_TRA_DIEN" ? (
          <KiemTraSauTongLapDienForm
...
if 'activeSubTabDef?.id === "KIEM_TRA_DIEN"' not in content:
