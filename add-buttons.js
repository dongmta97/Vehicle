const fs = require('fs');
const content = fs.readFileSync('src/components/DetailedSelectionProtocolForm.tsx', 'utf8');

const newContent = content.replace('          </fieldset>\n        </div>', `          </fieldset>
...
fs.writeFileSync('src/components/DetailedSelectionProtocolForm.tsx', newContent);
console.log("Success");
