...
if 'import { TayRuaLamSachCumDienForm }' not in content:
    content = 'import { TayRuaLamSachCumDienForm } from "./TayRuaLamSachCumDienForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "TAY_RUA_DIEN" ? (
          <TayRuaLamSachCumDienForm
...
if 'activeSubTabDef?.id === "TAY_RUA_DIEN"' not in content:
