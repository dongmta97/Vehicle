...
if 'import { LapRapHieuChinhGamForm }' not in content:
    content = 'import { LapRapHieuChinhGamForm } from "./LapRapHieuChinhGamForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "LAP_RAP_GAM" ? (
          <LapRapHieuChinhGamForm
...
if 'activeSubTabDef?.id === "LAP_RAP_GAM"' not in content:
