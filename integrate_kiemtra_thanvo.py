...
if 'import { KiemTraThanVoSauSuaChuaForm }' not in content:
    content = 'import { KiemTraThanVoSauSuaChuaForm } from "./KiemTraThanVoSauSuaChuaForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "KIEM_TRA_THAN_VO" ? (
          <KiemTraThanVoSauSuaChuaForm
...
if 'activeSubTabDef?.id === "KIEM_TRA_THAN_VO"' not in content:
