...
fs.writeFileSync(path.join(dir, 'ToyotaFortunerSelection.json'), JSON.stringify(data, null, 2), 'utf-8');
console.log('Toyota Fortuner Selection items:', data.sections.reduce((acc, sec) => acc + sec.items.length, 0));
