...
const data = {
  templateVersion: 1,
  vehicleCode: "TZ-SELECT",
  vehicleName: "Toyota Zace",
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Công tắc gạt mưa TH", quantity: "1b" },
        { name: "Công tắc xin nhan TH", quantity: "1b" },
...
fs.writeFileSync(path.join(dir, 'ToyotaZaceSelection.json'), JSON.stringify(data, null, 2), 'utf-8');
console.log('Toyota Zace Selection items:', data.sections.reduce((acc, sec) => acc + sec.items.length, 0));
