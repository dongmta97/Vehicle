...
if 'import { SuaChuaChiTietCumDienForm }' not in content:
    content = 'import { SuaChuaChiTietCumDienForm } from "./SuaChuaChiTietCumDienForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "SUA_CHUA_DIEN" ? (
          <SuaChuaChiTietCumDienForm
...
if 'activeSubTabDef?.id === "SUA_CHUA_DIEN"' not in content:
