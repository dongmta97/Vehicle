...
if 'import { SuaChuaChiTietCumGamForm }' not in content:
    content = 'import { SuaChuaChiTietCumGamForm } from "./SuaChuaChiTietCumGamForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "SUA_CHUA_GAM" ? (
          <SuaChuaChiTietCumGamForm
...
if 'activeSubTabDef?.id === "SUA_CHUA_GAM"' not in content:
