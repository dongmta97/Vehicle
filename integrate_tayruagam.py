...
if 'import { TayRuaLamSachCumGamForm }' not in content:
    content = 'import { TayRuaLamSachCumGamForm } from "./TayRuaLamSachCumGamForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "TAY_RUA_GAM" ? (
          <TayRuaLamSachCumGamForm
...
if 'activeSubTabDef?.id === "TAY_RUA_GAM"' not in content:
