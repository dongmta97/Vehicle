...
if 'import { KiemTraNoiThatSonSauSuaChuaForm }' not in content:
    content = 'import { KiemTraNoiThatSonSauSuaChuaForm } from "./KiemTraNoiThatSonSauSuaChuaForm";\n' + content

render_str = """
        ) : activeSubTabDef?.id === "KIEM_TRA_NOI_THAT_SON" ? (
          <KiemTraNoiThatSonSauSuaChuaForm
...
if 'activeSubTabDef?.id === "KIEM_TRA_NOI_THAT_SON"' not in content:
